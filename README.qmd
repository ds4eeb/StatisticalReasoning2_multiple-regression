...
confm.depth.length.species <- predict_response(m.depth.length.species, terms = c('bill_length_mm', 'species'))

# ggplot(data = confm.depth.length.species, aes(x = bill_length_mm, y = Predicted)) +
#   geom_line()
